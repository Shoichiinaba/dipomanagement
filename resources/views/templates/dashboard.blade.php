            ...
            <div class="header-wrapper row m-0">
                ...
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper"><a href="{{ url('/dashboard') }}"><img class="img-fluid"
                                src="{{ url('/html/assets/images/logo/logo-icon.png') }}" alt=""></a></div>
                    <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle"
                            data-feather="align-center"></i></div>
                </div>

                <div class="left-header col horizontal-wrapper ps-0">
                    <a href="{{ url('/switch/user') }}" class="btn btn-warning"
                        onclick="return confirm('Are You Sure ?')">Dashboard User</a>
                </div>
            ...
            <div class="sidebar-wrapper">
                <div>
                    <div class="logo-wrapper"><a href="{{ url('/dashboard') }}"><img class="img-fluid for-light"
                                src="{{ asset('/storage/'.$settings->logo) }}" style="width: 50px" alt=""></a>
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                <li class="back-btn"><a href="{{ url('/dashboard') }}"><img class="img-fluid"
                                            src="{{ url('/html/assets/images/logo/logo-icon.png') }}" alt=""></a>
                                ...
                                <li class="menu-box">
                                    <ul>
                                        ...
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                                href="{{ url('/kontrak') }}"><i data-feather="trending-up">
                                                </i><span>Kontrak</span></a>
                                        </li>

                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/exit') }}"><i
                                                    data-feather="user-minus"> </i><span>Pegawai Keluar</span></a>
                                        </li>

                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/shift') }}"><i
                                                    data-feather="git-pull-request"> </i><span>Shift</span></a>
                                        </li>
                                        ...
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                                ...
                                                </i><span>Divisi</span></a>
                                        </li>
                                        @endif

                                        @if (auth()->user()->hasRole('admin') ||
                                        auth()->user()->hasRole('kepala_cabang') || auth()->user()->hasRole('hrd') ||
                                        auth()->user()->hasRole('general_manager'))
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                        ...
                                        @if (auth()->user()->hasRole('admin') ||
                                        auth()->user()->hasRole('general_manager') || auth()->user()->hasRole('hrd'))
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                        ...
                                        <!-- <li class="sidebar-list"><a class="sidebar-link sidebar-title"
                                                href="javascript:void(0)"><i data-feather="wind"></i><span>Kinerja
                                                    Pegawai</span></a>
                                            <ul class="sidebar-submenu">
                                        ...
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav {{ Request::is('laporan-kerja*') ? 'active' : '' }}"
                                                href="{{ url('/laporan-kerja') }}"><i data-feather="message-square">
                                                </i><span>Laporan Kerja</span></a>
                                        </li>
                                        @endif

                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                                href="{{ url('/inventory') }}"><i data-feather="git-merge">
                                                </i><span>Inventory</span></a>
                                        </li>

                                        @if (auth()->user()->hasRole('admin') ||
                                        auth()->user()->hasRole('general_manager') || auth()->user()->hasRole('finance')
                                        || auth()->user()->hasRole('regional_manager'))
                                        <li class="sidebar-list"><a class="sidebar-link sidebar-title"
                                                href="javascript:void(0)"><i
                                            ...
                                            <ul class="sidebar-submenu">
                                                ...
                                                <li><a href="{{ url('/list-pengajuan-keuangan') }}">Pengajuan
                                                        Keuangan</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <!-- <li class="sidebar-list"><a class="sidebar-link sidebar-title"
                                                href="javascript:void(0)"><i
                                                    data-feather="sunrise"></i><span>Target</span></a>
                                            <ul class="sidebar-submenu">
                                        ...
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav {{ Request::is('dokumen*') ? 'active' : '' }}"
                                                href="{{ url('/dokumen') }}"><i data-feather="folder"> </i><span>Dokumen
                                                    Pegawai</span></a>
                                        </li>

                                        @if (auth()->user()->hasRole('admin'))
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav {{ Request::is('berita*') ? 'active' : '' }}"
                                                href="{{ url('/berita') }}"><i data-feather="star"> </i><span>Berita &
                                                    Informasi</span></a>
                                        </li>
