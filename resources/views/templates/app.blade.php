...
<body>
        ...
        <div class="tf-container">
            <div class="tf-topbar d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-4">
                    <a href="javascript:void(0);" id="btn-popup-left" hidden>
    ...
    @elseif(Request::is('my-profile*') || Request::is('laporan-kerja') || Request::is('laporan-kerja/show*') ||
    Request::is('cuti*') || Request::is('pengajuan-keuangan*') || Request::is('berita-user*') ||
